class EstimateLine < ApplicationRecord
  ...
  QB_KEYS = %w(txn_line_id item_ref desc quantity unit_of_measure override_UOM_set_ref rate rate_percent amount inventory_site_ref inventory_site_location_ref sales_tax_code_ref markup_rate markup_rate_percent)
