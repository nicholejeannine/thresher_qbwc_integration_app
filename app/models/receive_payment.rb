class ReceivePayment < ApplicationRecord
  ...
  QB_KEYS = %w(txn_id time_created time_modified edit_sequence txn_number customer_ref ar_account txn_date ref_number total_amount payment_method memo deposit_to_account unused_payment unused_credits URL)
  def self.attributes
