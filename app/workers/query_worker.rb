  ...
  def requests(job, session, data)
   [
    {:customer_query_rq => {
       ...
       :include_ret_element => ['ListID', 'TimeCreated', 'TimeModified', 'Name', 'FullName', 'IsActive', 'CompanyName', 'Salutation', 'FirstName', 'MiddleName', 'LastName', 'BillAddress', 'ShipAddress','Phone', 'AltPhone', 'Fax', 'Email', 'Cc', 'AdditionalContactRef', 'SalesRepRef', 'TotalBalance', 'JobStatus', 'JobStartDate', 'JobProjectedEndDate', 'JobEndDate', 'DataExtRet'],
       :owner_id => 0
       }
     },
     # {:vendor_query_rq => {
