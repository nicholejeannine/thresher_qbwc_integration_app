class CreateClientBillAddresses < ActiveRecord::Migration[5.0]
  def change
    create_table :client_bill_addresses, id: :string, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
