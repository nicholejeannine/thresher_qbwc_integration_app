...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "FullName", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "Jobs_PKEY",                  default: 0, null: false
    t.text    "FullName",  limit: 16777215
  end

  create_table "FullNameFields", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "Jobs_PKEY",               default: 0, null: false
    t.text    "cust",      limit: 65535,                          comment: "Customer Short Name"
    t.text    "jp3",       limit: 65535
    t.text    "jp2",       limit: 65535
    t.text    "jp1",       limit: 65535
    t.text    "pj",        limit: 65535
  end
  ...
  create_table "ProjectFullName", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "Project_PKEY",                       default: 0, null: false
    t.text    "project_full_name", limit: 16777215
  end
  ...
  create_table "SalesDeltas", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.text     "Cust_CompanyAbr", limit: 65535
    t.text     "Est_Number",      limit: 65535
    t.datetime "Est_Created",                   default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.text     "SO_Number",       limit: 65535
    t.datetime "SO_Created",                                                         null: false
    t.integer  "Est_SO_Delta"
    t.text     "Inv_Number",      limit: 65535
    t.datetime "Inv_Created",                                                        null: false
    t.integer  "SO_Inv_Delta"
    t.integer  "Pay_Number"
    t.date     "Pay_Created"
    t.integer  "Inv_Pay_Delta"
  end
  ...
  create_table "Tickets", primary_key: "Tickets_PKEY", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer  "Tick_Billable",                           default: 0, null: false
    t.integer  "Tick_Van",                  limit: 1,     default: 1, null: false
  ...
  create_table "client_combos", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.text     "Cust_BillTo_Company",       limit: 65535
    t.text     "Cust_BillTo_Country",       limit: 65535
    t.text     "Cust_BillTo_Email",         limit: 65535
    t.text     "Cust_BillTo_Name",          limit: 65535
    t.text     "Cust_AP_Name",              limit: 65535
    t.text     "Cust_BillTo_Phone",         limit: 65535
    t.text     "Cust_BillTo_State",         limit: 65535
    t.integer  "Cust_BillTo_Zip"
    t.text     "Cust_City",                 limit: 65535
    t.text     "Cust_CLNo",                 limit: 65535
    ...
    t.text     "Cust_PhoneAlt",             limit: 65535
    t.text     "Cust_PhoneCell",            limit: 65535
    t.text     "Cust_PhoneFax",             limit: 65535
    t.text     "Cust_PhoneOffice",          limit: 65535
    t.text     "Cust_PONo",                 limit: 65535
    t.text     "Cust_Rep",                  limit: 65535
    t.text     "Cust_SaleTaxCode",          limit: 65535
  ...
  create_table "clients", primary_key: "Customers_PKEY", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.text     "Cust_Type",                 limit: 65535
    t.integer  "Cust_Zip"
    t.index ["full_name"], name: "full_name", using: :btree
  ...
  create_table "estimate_combos", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "qEstimates_PKEY"
    t.string   "id"
    t.datetime "time_created"
    t.datetime "time_modified"
    t.string   "edit_sequence",                limit: 16
    ...
    t.text     "Est_Company",                  limit: 65535
    t.text     "Est_CompanyAbr",               limit: 65535
    t.text     "Est_Contact",                  limit: 65535
    t.text     "Est_ContactAlt",               limit: 65535
    t.text     "Est_CPR",                      limit: 65535
    ...
    t.text     "Est_EmailCC",                  limit: 65535
    t.text     "Est_EmailTo",                  limit: 65535
    t.text     "Est_NameFirst",                limit: 65535
    t.text     "Est_NameLast",                 limit: 65535
    t.text     "Est_NameMiddle",               limit: 65535
    t.text     "Est_NameSalutation",           limit: 65535
    t.text     "Est_Notes",                    limit: 65535
    t.text     "Est_Number",                   limit: 65535
    t.integer  "Est_PercentComplete"
    t.text     "Est_PhoneAlt",                 limit: 65535
    t.text     "Est_PhoneFax",                 limit: 65535
    t.text     "Est_PhoneOffice",              limit: 65535
    t.text     "Est_ProjectName",              limit: 65535
    t.text     "Est_Status",                   limit: 65535
    t.text     "Est_URL",                      limit: 65535
    t.text     "Est_URL BU",                   limit: 65535
  end
  ...
  create_table "estimates", primary_key: "qEstimates_PKEY", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "id",                                                                                  null: false
    t.datetime "time_created"
    t.datetime "time_modified"
    t.string   "edit_sequence",                limit: 16
    ...
    t.index ["id"], name: "id", using: :btree
    t.index ["is_active"], name: "is_active", using: :btree
    t.index ["qEstimates_PKEY"], name: "qEstimates_PKEY", unique: true, using: :btree
  ...
  create_table "invoice_combos", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "qInvoices_PKEY"
    t.string   "id"
    t.datetime "time_created"
    t.datetime "time_modified"
    t.string   "edit_sequence",             limit: 16
    ...
    t.integer  "FK_Customers_PKEY"
    t.integer  "FK_qSalesOrders_PKEY"
    t.decimal  "Inv_Amount",                              precision: 10, scale: 2
    t.date     "Inv_DateCreated"
    t.date     "Inv_DateInvoiceApproved"
    t.date     "Inv_DateInvoiceConfirmed"
    t.date     "Inv_DateInvoicePaid"
    t.date     "Inv_DateScheduled"
    t.date     "Inv_DateSent"
    t.text     "Inv_Description",           limit: 65535
    t.text     "Inv_InvConfirmedNote",      limit: 65535
    t.text     "Inv_InvSentTo",             limit: 65535
    t.integer  "Inv_InvSentVia",            limit: 1
    t.text     "Inv_Notes",                 limit: 65535
    t.text     "Inv_Number",                limit: 65535
    t.text     "Inv_PaidMethod",            limit: 65535
    t.text     "Inv_PaymentURL",            limit: 65535
    t.text     "Inv_PaymentURL BU",         limit: 65535
    t.text     "Inv_ProjectName",           limit: 65535
    t.integer  "Inv_Status",                limit: 1
    t.integer  "Inv_Terms",                 limit: 1
    t.text     "Inv_URL",                   limit: 65535
    t.text     "Inv_URL BU",                limit: 65535
  ...
  create_table "invoices", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "qInvoices_PKEY"
    t.string   "id",                                                                               null: false
    t.datetime "time_created"
    t.datetime "time_modified"
    ...
    t.index ["estimate_id"], name: "estimate_id", using: :btree
    t.index ["id"], name: "id", using: :btree
    t.index ["qInvoices_PKEY"], name: "qInvoices_PKEY", using: :btree
    t.index ["ref_number"], name: "ref_number", using: :btree
    t.index ["sales_order_id"], name: "sales_order_id", using: :btree
  end

  create_table "job1s", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "Jobs_PKEY",                                                        default: 0,     null: false
    t.string   "id",                                                                               null: false
    t.datetime "time_created"
    t.datetime "time_modified"
  ...
  create_table "job2s", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "Jobs_PKEY",                                                        default: 0,     null: false
    t.string   "id",                                                                               null: false
    t.datetime "time_created"
    t.datetime "time_modified"
  ...
  create_table "job3s", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "Jobs_PKEY",                                                        default: 0,     null: false
    t.string   "id",                                                                               null: false
    t.datetime "time_created"
    t.datetime "time_modified"
  ...
  create_table "job4s", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "Jobs_PKEY",                                                        default: 0,     null: false
    t.string   "id",                                                                               null: false
    t.datetime "time_created"
    t.datetime "time_modified"
  ...
  create_table "job_combos", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "Jobs_PKEY"
    t.string   "id"
    t.datetime "time_created"
    t.datetime "time_modified"
    ...
    t.integer  "Job_HoursAmount_Max"
    t.text     "Job_HourType",              limit: 65535
    t.text     "Job_InactiveFlag",          limit: 65535
    t.text     "Job_NameFirst",             limit: 65535
    t.text     "Job_NameLast",              limit: 65535
    t.text     "Job_NameMiddle",            limit: 65535
    t.text     "Job_NameSalutation",        limit: 65535
  ...
  create_table "payment_combo_matches", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "qInvoices_PKEY",                                     default: 0
    t.integer "Payments_PKEY",                                      default: 0,  null: false
    t.string  "QB Payment id",                                                   null: false
    t.decimal "Portal Amount",             precision: 10, scale: 2
    t.string  "QB Amount",      limit: 22,                          default: "", null: false, collation: "utf8mb4_general_ci"
    t.date    "Portal Date"
    t.date    "QB Date"
  end

  create_table "payment_combos", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "Payments_PKEY"
    t.string   "id"
    t.datetime "time_created"
    t.datetime "time_modified"
    t.string   "edit_sequence",             limit: 16
    ...
    t.decimal  "unused_payment",                          precision: 20, scale: 5
    t.decimal  "unused_credits",                          precision: 20, scale: 5
    t.datetime "CreationTimeStamp",                                                default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.text     "CreationUser",              limit: 65535
    t.datetime "LastModificationTimeStamp",                                                                             null: false
    t.text     "LastModificationUser",      limit: 65535
  ...
  create_table "project_combos", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "project_qb_portal_comparisons", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "Project_PKEY",                                 default: 0, null: false
    t.text    "Calculated Portal Full Name", limit: 16777215
    t.string  "Full name in Quickbooks",     limit: 209
  end

  create_table "projects", primary_key: "Project_PKEY", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "id"
    t.datetime "time_created"
    t.datetime "time_modified"
    t.string   "edit_sequence",                 limit: 16
  ...
  create_table "projects_copy", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "Project_PKEY",                                                            default: 0,     null: false
    t.string   "id"
    t.datetime "time_created"
    t.datetime "time_modified"
  ...
  create_table "projects_in_portal_but_not_quickbooks", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "Project_PKEY",                                                            default: 0,     null: false
    t.string   "id"
    t.datetime "time_created"
    t.datetime "time_modified"
  ...
  create_table "projects_null_ids", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "Project_PKEY",                                                            default: 0,     null: false
    t.string   "id"
    t.datetime "time_created"
    t.datetime "time_modified"
  ...
  create_table "purchase_orders", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "qPurchaseOrders_PKEY",                                             default: 0
    t.string   "id",                                                                               null: false
    t.datetime "time_created"
    t.datetime "time_modified"
    ...
    t.index ["id"], name: "id", using: :btree
    t.index ["qPurchaseOrders_PKEY"], name: "qPurchaseOrders_PKEY", using: :btree
    t.index ["ref_number"], name: "ref_number", using: :btree
    t.index ["sales_order_id"], name: "sales_order_id", using: :btree
    t.index ["vendor_id"], name: "vendor_id", using: :btree
  end

  create_table "purchase_orders_copy", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "qPurchaseOrders_PKEY",                                             default: 0
    t.string   "id",                                                                               null: false
    t.datetime "time_created"
    t.datetime "time_modified"
  ...
  create_table "qShipments", primary_key: "qShipments_PKEY", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.text     "Ship_TrackingNumber",       limit: 65535
  ...
  create_table "receive_payments", id: :string, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.text     "URL",                limit: 65535
    t.index ["Payments_PKEY"], name: "Payments_PKEY", using: :btree
  ...
  create_table "sales_orders", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "qSalesOrders_PKEY",                                                 default: 0
    t.string   "id",                                                                                null: false
    t.datetime "time_created"
    t.datetime "time_modified"
    t.string   "edit_sequence"
    ...
    t.integer  "FK_TechLead_Employees_PKEY"
    t.text     "SO_Description",             limit: 65535,                                                       collation: "utf8_unicode_ci"
    t.index ["customer_type", "customer_id"], name: "customer_type", using: :btree
    t.index ["estimate_id"], name: "estimate_id", using: :btree
    t.index ["id"], name: "id", using: :btree
    t.index ["qSalesOrders_PKEY"], name: "qSalesOrders_PKEY", using: :btree
    t.index ["ref_number"], name: "ref_number", using: :btree
  end
  ...
  create_table "viewpagequestions", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "Review_Categories_PKEY",                     default: 0, null: false
    t.text    "Review_Categories_Name",       limit: 65535,                          collation: "utf8_unicode_ci"
    t.integer "pageNumber",                                             null: false,                               unsigned: true
    t.integer "Review_Questions_PKEY",                      default: 0, null: false
    t.text    "Review_Questions_Description", limit: 65535,                          collation: "utf8_unicode_ci"
    t.integer "FK_Employees_List_Title_PKEY"
    t.text    "Review_Questions_Text",        limit: 65535,                          collation: "utf8_unicode_ci"
    t.bigint  "Sort_Order",                                 default: 0, null: false
  end
