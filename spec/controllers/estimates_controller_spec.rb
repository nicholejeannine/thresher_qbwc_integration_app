...
RSpec.describe EstimatesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested estimate as @estimate" do
      estimate = Estimate.create! valid_attributes
      get :show, params: {id: estimate.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested estimate as @estimate" do
      estimate = Estimate.create! valid_attributes
      get :edit, params: {id: estimate.to_param}, session: valid_session
      expect(assigns(:estimate)).to eq(estimate)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Estimate" do
        expect {
          post :create, params: {estimate: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved estimate as @estimate" do
        post :create, params: {estimate: invalid_attributes}, session: valid_session
        expect(assigns(:estimate)).to be_a_new(Estimate)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested estimate" do
        estimate = Estimate.create! valid_attributes
        put :update, params: {id: estimate.to_param, estimate: new_attributes}, session: valid_session
        estimate.reload
      ...
      it "assigns the requested estimate as @estimate" do
        estimate = Estimate.create! valid_attributes
        put :update, params: {id: estimate.to_param, estimate: valid_attributes}, session: valid_session
        expect(assigns(:estimate)).to eq(estimate)
      end
    ...
    context "with invalid params" do
      it "assigns the estimate as @estimate" do
        estimate = Estimate.create! valid_attributes
        put :update, params: {id: estimate.to_param, estimate: invalid_attributes}, session: valid_session
        expect(assigns(:estimate)).to eq(estimate)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested estimate" do
      estimate = Estimate.create! valid_attributes
      expect {
        delete :destroy, params: {id: estimate.to_param}, session: valid_session
      }.to change(Estimate, :count).by(-1)
    end
