...
RSpec.describe InvoiceLinesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested invoice_line as @invoice_line" do
      invoice_line = InvoiceLine.create! valid_attributes
      get :show, params: {id: invoice_line.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested invoice_line as @invoice_line" do
      invoice_line = InvoiceLine.create! valid_attributes
      get :edit, params: {id: invoice_line.to_param}, session: valid_session
      expect(assigns(:invoice_line)).to eq(invoice_line)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new InvoiceLine" do
        expect {
          post :create, params: {invoice_line: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved invoice_line as @invoice_line" do
        post :create, params: {invoice_line: invalid_attributes}, session: valid_session
        expect(assigns(:invoice_line)).to be_a_new(InvoiceLine)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested invoice_line" do
        invoice_line = InvoiceLine.create! valid_attributes
        put :update, params: {id: invoice_line.to_param, invoice_line: new_attributes}, session: valid_session
        invoice_line.reload
      ...
      it "assigns the requested invoice_line as @invoice_line" do
        invoice_line = InvoiceLine.create! valid_attributes
        put :update, params: {id: invoice_line.to_param, invoice_line: valid_attributes}, session: valid_session
        expect(assigns(:invoice_line)).to eq(invoice_line)
      end
    ...
    context "with invalid params" do
      it "assigns the invoice_line as @invoice_line" do
        invoice_line = InvoiceLine.create! valid_attributes
        put :update, params: {id: invoice_line.to_param, invoice_line: invalid_attributes}, session: valid_session
        expect(assigns(:invoice_line)).to eq(invoice_line)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested invoice_line" do
      invoice_line = InvoiceLine.create! valid_attributes
      expect {
        delete :destroy, params: {id: invoice_line.to_param}, session: valid_session
      }.to change(InvoiceLine, :count).by(-1)
    end
