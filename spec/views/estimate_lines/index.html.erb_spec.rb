...
RSpec.describe "estimate_lines/index", type: :view do
  before(:each) do
    assign(:estimate_lines, [
      EstimateLine.create!(
  ...
  it "renders a list of estimate_lines" do
    render
    assert_select "tr>td", :text => "Estimate".to_s, :count => 2
