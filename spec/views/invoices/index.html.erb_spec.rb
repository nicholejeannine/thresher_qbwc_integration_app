...
RSpec.describe "invoices/index", type: :view do
  before(:each) do
    assign(:invoices, [
      Invoice.create!(
        ...
        :ar_account_full_name => "Ar Account Full Name",
        ...
        :is_finance_charge => "Is Finance Charge",
        :po_number => "Po Number",
        :terms_id => "Terms",
        ...
        :suggested_discount_amount => "9.99",
  ...
  it "renders a list of invoices" do
    ...
    assert_select "tr>td", :text => "Ar Account".to_s, :count => 2
    assert_select "tr>td", :text => "Ar Account Full Name".to_s, :count => 2
    ...
    assert_select "tr>td", :text => "Is Pending".to_s, :count => 2
    assert_select "tr>td", :text => "Is Finance Charge".to_s, :count => 2
