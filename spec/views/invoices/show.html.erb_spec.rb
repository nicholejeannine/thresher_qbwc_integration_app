...
RSpec.describe "invoices/show", type: :view do
  ...
  it "renders attributes in <p>" do
    ...
    expect(rendered).to match(/Ar Account/)
    expect(rendered).to match(/Ar Account Full Name/)
    ...
    expect(rendered).to match(/Is Pending/)
    expect(rendered).to match(/Is Finance Charge/)
    ...
    expect(rendered).to match(/Is Paid/)
