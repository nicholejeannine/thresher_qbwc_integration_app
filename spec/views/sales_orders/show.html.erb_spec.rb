...
RSpec.describe "sales_orders/show", type: :view do
  before(:each) do
    @sales_order = assign(:sales_order, SalesOrder.create!(
      :id => "Id",
      ...
      :is_fully_invoiced => "Is Fully Invoiced",
      :memo => "MyText",
  ...
  it "renders attributes in <p>" do
    ...
    expect(rendered).to match(/Is Fully Invoiced/)
