...
class ClientTest < ActiveSupport::TestCase
  ...
  test "nullifies data extension values when not explicitly defined" do
    ...
    assert_equal("", Client.first.site_contact, "Custom data types not present in hash should be treated as an empty string. (Failed to nullify site_contact.)")
    assert_equal("", Client.first.site_phone, "Custom data types not present in hash should be treated as an empty string. (Failed to nullify site_phone.)")
    assert_equal("", Client.first.site_email, "Custom data types not present in hash should be treated as an empty string. (Failed to nullify site_email.)")
  end
