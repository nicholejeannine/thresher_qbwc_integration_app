...
class ClientTest < ActiveSupport::TestCase
  ...
  test "nullifies data extension values when not explicitly defined" do Customer.parse_customer_response({'list_id' => '111-111', 'sublevel' => 0, 'name' => 'Frankie', 'full_name' => 'Frankie'})
