...
class ClientTest < ActiveSupport::TestCase
  ...
  setup do
    Client.destroy_all
    qb_customer_hash = {"list_id" => '111-111', "is_active" => 1, "sublevel" => 0, "name" => "Frankie", "full_name" => "Frankie", "salutation" => "Joe", "bill_address" => {"xml_attributes" => "some crap", "addr1" => "333 Street"}, "ship_address" => {"xml_attributes" => "some crap", "addr1" => "444 Street"}, "customer_type_ref" => {"list_id" => 'xxx-33333', "full_name" => "Corporate"}, "terms_ref" => {"list_id" => "897219-87981", "full_name" => "Net 30"}, "sales_rep_ref" => {"list_id" => "yyyy-yyyy", "full_name" => "NJK"}, "sales_tax_code_ref" => {"list_id" => "ihkjkj", "full_name" => "Tax"}, "item_sales_tax_ref" => {"list_id" => "87879-3882", "full_name" => "SC/CA"}, "data_ext_ret"=> [{'data_ext_name' => 'Site Contact', 'data_ext_type' => "String", 'data_ext_value' => 'Frankie Jones'},{'data_ext_name' => 'Site Phone', 'data_ext_type' => "String", 'data_ext_value' => '555-555-5555'}, {'data_ext_name' => 'Site Email', 'data_ext_type' => "String", 'data_ext_value' => 'email.com'}] }
