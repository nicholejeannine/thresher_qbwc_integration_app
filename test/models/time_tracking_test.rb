...
class TimeTrackingTest < ActiveSupport::TestCase
  ...
  #   hash =  {"xml_attributes"=>{"statusCode"=>"0", "statusSeverity"=>"Info", "statusMessage"=>"Status OK", "iteratorRemainingCount"=>"225192", "iteratorID"=>"{5ba9f6cd-0413-46dc-8465-4feae3f7d7aa}"}, "time_tracking_ret"=>[{"xml_attributes"=>{}, "txn_id"=>"5CA94-1183243364", "time_created"=>"2007-06-30T15:42:44-08:00", "time_modified"=>"2007-06-30T15:42:44-08:00", "edit_sequence"=>"1183243364", "txn_number"=>0, "txn_date"=>"2017-06-11", "entity_ref"=>{"xml_attributes"=>{}, "list_id"=>"5150000-1173314561", "full_name"=>"Joe Bean"}, "customer_ref"=>{"xml_attributes"=>{}, "list_id"=>"49B0000-1133993641", "full_name"=>"Google:Construction:Rooftop:P-11"}, "item_service_ref"=>{"xml_attributes"=>{}, "list_id"=>"31A0000-989981084", "full_name"=>"Video:0100"}, "duration"=>"PT7H30M", "class_ref"=>{"xml_attributes"=>{}, "list_id"=>"200000-991719211", "full_name"=>"Video:Cabling Mgmt"}, "payroll_item_wage_ref"=>{"xml_attributes"=>{}, "list_id"=>"E0000-875338868", "full_name"=>"Hourly Level 1"}, "notes"=>"Ticket 10", "billable_status"=>"NotBillable"}]}
  #   TimeTracking.parse_qb_response(hash)
  #   assert_equal(100, TimeTracking.count)
  #   assert_equal("2017-06-11", TimeTracking.first.txn_date.iso8601)
